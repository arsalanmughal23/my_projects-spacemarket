    ...
    <div class="card card-primary card-outline card-tabs">
        <div class="card-header p-0 pt-1 border-bottom-0">
            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-three-section2-tab" data-toggle="pill" href="#custom-tabs-three-section2" role="tab" aria-controls="custom-tabs-three-section2" aria-selected="false">Section 2</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
            <div class="tab-content" id="custom-tabs-three-tabContent">
                ...
                <div class="tab-pane fade active show" id="custom-tabs-three-section1" role="tabpanel" aria-labelledby="custom-tabs-three-section1-tab">
                    @include('components.admin.cms_forms.support.contact_us.section1', [ 'pageSlug' => $pageSlug ])
                </div>

                <div class="tab-pane fade" id="custom-tabs-three-section2" role="tabpanel" aria-labelledby="custom-tabs-three-section2-tab">
                    @include('components.admin.cms_forms.support.contact_us.section2', [ 'pageSlug' => $pageSlug ])
                </div>
