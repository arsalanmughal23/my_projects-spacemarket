<form action="{{ route('home.update') }}" method="post">
    ...
    <div class="row">
        ...
        <div class="form-group col-sm-12">
            ...
            {!! Form::text('sub_title', $section4['sub_title'] ?? null, ['class' => 'form-control', 'maxlength' => config('constants.character_limits.sub_title'), 'required' => 'required']) !!}
        </div>

        <!-- Button Text Field -->
        <div class="form-group col-sm-12">
            {!! Form::label('button_text', 'Button Text:', [ 'class' => 'required' ]) !!}
            {!! Form::textarea('button_text', $section4['button_text'] ?? null, ['class' => 'form-control summernote', 'maxlength' => config('constants.character_limits.button_text'), 'required' => 'required']) !!}
        </div>
        ...
        <div class="form-group col-sm-12">
            ...
            <!-- , [ 'class' => 'required' ] -->
            {!! Form::url('button_link', $section4['button_link'] ?? null, ['class' => 'form-control', 'maxlength' => config('constants.character_limits.button_link')]) !!}
            <!-- , 'required' => 'required' -->
        </div>
