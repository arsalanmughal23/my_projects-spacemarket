<form action="{{ route('support.update', 'about_us') }}" method="post">
    ...
    <div class="row">
        ...
        <div class="form-group col-sm-12">
            ...
            {!! Form::textarea('description', $section2['description'] ?? null, ['class' => 'form-control summernote','maxlength' => config('constants.character_limits.short_description'), 'required' => 'required']) !!}
        </div>
